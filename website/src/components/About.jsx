  ...
  return (
    <div className="h-auto">
      <div className=" text-white h-auto">
        <section className="mx-5 md:mx-10 min-h-[700px] bg-[#0038c7] relative ">
          ...
          <div className="absolute inset-0 top-16 sm:top-2 flex flex-col justify-start items-center text-black ">
            <div className="text-center">
              <div className="font-brasika text-4xl sm:text-6xl md:text-8xl">you may be thinkin</div>
              <div className="font-brasika text-4xl sm:text-6xl md:text-8xl">who the <span className="text-lime-500">hell</span> we are?</div>
            </div>
